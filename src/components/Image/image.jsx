        ...
        <div class="flex justify-center relative mix-blend-lighten">
            ...
            <div className="absolute  w-auto mx-44 sm:mx-60 mt-2 sm:mt-2 md:mt-3 lg:mt-10 xl:mt-6 2xl:mt-40 object-cover object-right">
                <div className='flex flex-col font-Montserrat'>
                    ...
                    <p className='text-white text-2xl my-10 font-light'>We are committed to helping millennial's, graduates small business owners, 
                        and entrepreneurs realize their potential and achieve success.
</p>
