    ...
    <div className="w-full flex flex-col justify-between items-start max-w-sm p-4 bg-white rounded-lg shadow-2xl sm:p-8 font-Montserrat mx-3 h-[90vh]">
          ...
          {actions.map((text, key) => {
            return (
              <li className="flex space-x-3    ">
                <svg
                  aria-hidden="true"
                  className="flex-shrink-0 w-5 h-5 text-[#DAA624] "
                  fill="currentColor"
                  viewBox="0 0 600 600"
      ...
      <div style={{ textAlign: "end" }} className="w-full self-end">
        <a
          href={url}
          type="button"
          className=" text-white bg-[#DAA624] hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
        >
          Choose
        </a>
      </div>
